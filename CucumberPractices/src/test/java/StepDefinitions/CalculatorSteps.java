...
public class CalculatorSteps {
	...
	@Given("user is navigated to the AUT")
	...
	@Then("verify result amount")
	public void dfgdf() {
		WebElement BorrowedAmount = driver.findElement(By.id("borrowResultTextAmount"));
		System.out.println("Amount You can borrow : "+BorrowedAmount.getText());
		driver.close();
	}
